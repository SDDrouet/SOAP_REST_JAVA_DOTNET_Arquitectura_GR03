...
public class MenuFrm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Elegir Conversión");
        ...
        txtNotification.setBackground(new java.awt.Color(255, 255, 255));
        txtNotification.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        txtNotification.setForeground(new java.awt.Color(255, 255, 255));
        txtNotification.setText("Resultado");
        ...
        cmbSelect.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        cmbSelect.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Centímetros a Pulgadas", "Pulgadas a Centímetros" }));
        ...
        jPanel1Layout.setHorizontalGroup(
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(cmbSelect, javax.swing.GroupLayout.Alignment.LEADING, 0, 297, Short.MAX_VALUE)
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                    .addGap(306, 306, 306)
                    .addComponent(btnExit1, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnCalculateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalculateActionPerformed
        ...
        int selectFunction = cmbSelect.getSelectedIndex(); // 0: cm a pulgadas, 1: pulgadas a cm

        try {
            double number = Double.parseDouble(txtValue.getText());

            double result;
            String unidad;

            if (selectFunction == 0) {
                result = clientController.centimetrosAPulgadas(number);
                unidad = " pulgadas";
            } else {
                result = clientController.pulgadasACentimetros(number);
                unidad = " cm";
            }

            txtResult.setText(String.format("%.2f%s", result, unidad)); // Ej: 25.40 cm

        } catch (NumberFormatException e) {
            txtResult.setText("Error: número inválido");
        }
