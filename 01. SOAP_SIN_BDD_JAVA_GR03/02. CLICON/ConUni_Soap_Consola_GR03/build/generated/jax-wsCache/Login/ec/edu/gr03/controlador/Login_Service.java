 ...
 * 
 */
@WebServiceClient(name = "Login", targetNamespace = "http://controlador.gr03.edu.ec/", wsdlLocation = "http://localhost:8080/ConUni_Soap_Java_GR03/Login?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGIN_QNAME = new QName("http://controlador.gr03.edu.ec/", "Login");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ConUni_Soap_Java_GR03/Login?wsdl");
    ...
    public Login getLoginPort() {
        return super.getPort(new QName("http://controlador.gr03.edu.ec/", "LoginPort"), Login.class);
    }
    ...
    public Login getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://controlador.gr03.edu.ec/", "LoginPort"), Login.class, features);
    }
